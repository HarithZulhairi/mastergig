...
class foremanRatingAddFormPage extends StatefulWidget {
  ...
  @override
  State<foremanRatingAddFormPage> createState() => _foremanRatingAddFormPageState();
}

class _foremanRatingAddFormPageState extends State<foremanRatingAddFormPage> {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      performance: 0, // Use the performance rating
      workDate: _selectedDate,
      startTime: _startTime,
      endTime: _endTime,
      amenities: _amenities, // Use the amenities rating
      );
        ...
        builder: (context) {
          Future.delayed(const Duration(seconds: 1), () {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (_) => foremanRatingViewPage(rating: rating),
              ),
            );
          });
          return AlertDialog(
