...
class foremanRatingEditFormPage extends StatefulWidget {
  final Rating rating;

  const foremanRatingEditFormPage({super.key, required this.rating});

  @override
  State<foremanRatingEditFormPage> createState() => _foremanRatingEditFormPageState();
}

class _foremanRatingEditFormPageState extends State<foremanRatingEditFormPage> {
  ...
  void initState() {
    ...
    _amenities = widget.rating.amenities;
  }
  ...
  try {
    final updatedRating = Rating(
      ...
      userType: 'Foreman', // Assuming userType is always 'Foreman' for this form
      workshopName: _workshopNameController.text.trim(),
      feedback: _feedbackController.text.trim(),
      performance: _amenities,
      ...
      children: [
        ...
        Row(
          ...
          children: List.generate(5, (index) {
            ...
            return IconButton(
              icon: Icon(
                starNumber <= _amenities ? Icons.star : Icons.star_border,
                color: Colors.amber,
                size: 40,
              ),
              onPressed: () {
                setState(() {
                  _amenities = starNumber;
                });
              },
            );
          }),
