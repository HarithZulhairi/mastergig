...
class foremanRatingViewPage extends StatelessWidget {
  final Rating rating;

  const foremanRatingViewPage({super.key, required this.rating});
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _buildAmenitiesStars(rating.amenities),
  ...
  Widget _buildAmenitiesStars(int rating) {
    return Row(
